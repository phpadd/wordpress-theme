...
class d_comment extends WP_Widget {
	function d_comment() {
		$widget_ops = array( 'classname' => 'd_comment', 'description' => '显示网友最新评论（头像+名称+评论）默认排除用户ID为1' );
		$this->WP_Widget( 'd_comment', 'sky-最新评论', $widget_ops, $control_ops );
	}
